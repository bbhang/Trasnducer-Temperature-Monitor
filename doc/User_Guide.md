...
3. **Enter the console operating settings** (*Transmit params* tab,
   ...
   - *Frame rate* and *PRF* fill automatically only when the exact
     ...
     (console SW V1.0.0.105919, line density UH, 15 cm depth; B+C
     additionally requires B Opt GEN and C ROI 0–1 cm); any other
     combination leaves them empty — enter the values read from the
     console/oscilloscope manually.
...
All checks pass as of 2026-06-10 (V1.3.10).
